...
<p><label for="email">Mail*</label><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" /></p>
...
<p><input name="submit" type="submit" id="submit-comment" tabindex="5" value="Submit Comment" />
