				...
				<h1 class="hideOnSearch"><?php if ( $fields['year']){ echo $fields['year'];}else {  echo ''; }?> <?php the_title();?></h1>
                 ...
                 <div class="clear"></div>
					<ul class="quick-list quick-glance hideOnSearch ">
           				...
           				<?php	if ( is_numeric($fields['miles'])){echo  '<li><p class="strong">'.$options['milestext'].':</p> '.
           				
           				number_format($fields['miles'],0,'.',',').'</li>';} else { echo '<li><p class="strong">'.$options['milestext'].':</p> '.$fields['miles'].'</li>'; }?>
